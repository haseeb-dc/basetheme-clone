				...
				<div class="single-widget">
					...
					<div class="social-icons d-flex">
						...
						if ( $basethemevar_social_tw ) {
							?>
							<a href="<?php echo $basethemevar_social_tw; ?>" target="_blank" class="tweeter flex-center"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/twitter-icon.svg" alt="Twitter Icon" /></a><?php } ?>
						<?php
