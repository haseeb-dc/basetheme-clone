...
/***/ "./assets/src/js/vendor sync recursive \\.js$":
/*!******************************************!*\
  !*** ./assets/src/js/vendor/ sync \.js$ ***!
  \******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var map = {
	"./owl.carousel.min.js": "./assets/src/js/vendor/owl.carousel.min.js",
	"./topbar.js": "./assets/src/js/vendor/topbar.js"
};
...
webpackContext.resolve = webpackContextResolve;
module.exports = webpackContext;
webpackContext.id = "./assets/src/js/vendor sync recursive \\.js$";
...
/***/ "./assets/src/js/vendor/owl.carousel.min.js":
/*!**************************************************!*\
  !*** ./assets/src/js/vendor/owl.carousel.min.js ***!
  \**************************************************/
/***/ (() => {
...
!function (a, b, c, d) {
  ...
  e.Defaults = {
    nav: !1,
    navText: ['<span aria-label="Previous" role="link"></span>', '<span aria-label="Next" role="link"></span>'],
    navSpeed: !1,
...
/***/ "./assets/src/js/vendor/topbar.js":
/*!****************************************!*\
  !*** ./assets/src/js/vendor/topbar.js ***!
  \****************************************/
/***/ (() => {
...
jQuery.fn.topBar = function () {
  return this.each(function () {
    ...
    function setWithExpiry(key, value) {
      let discount = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      let ttl = arguments.length > 3 ? arguments[3] : undefined;
      const now = new Date();
      const item = {
        value,
        discount,
...
requireAll(__webpack_require__("./assets/src/js/vendor sync recursive \\.js$"));
